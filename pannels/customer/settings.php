            ...
            <div class="py-2">
                ...
                <div class="row py-2">                    
                    <div class="col-md-6 pt-md-0" id="lang">
                        ...
                        <div class="arrow">
                            <select class="bg-light w-100 form-control" name="language" id="gtype"  >
                    ...
                    <div class="col-md-6 pt-md-0" id="lang">
                        <label for="language">Size</label>
                        <div class="arrow">
                            <select class="bg-light w-100 form-control" name="language" id="gsize" >
                                <option value="2" selected>2Kg Tank</option>
                                <option value="5">5Kg Tank</option>
                                <option value="12.5">12.5Kg Tank</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="py-3 pb-4 border-bottom">
                    <button class="btn btn-primary mr-3" id="txtSave" >Change Details</button>
                ...
                <div class="d-sm-flex align-items-center pt-3" id="deactivate">
                    ...
                    <div class="ml-auto">
                        <button class="btn btn-danger" id="delAcc">Delete</button>
                    </div>
                </div>
            </div>
        </div>
