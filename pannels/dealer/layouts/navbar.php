  ...
  <header id="header" class="header d-flex align-items-center fixed-top" style="background: rgba(0, 0, 0, 0.4);">
    <div class="container container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="dhome.php">Home</a></li>
          <li class="dropdown"><a href="#"><span>Options</span> <i class="fa fa-caret-down" aria-hidden="true"></i></a>
            <ul>
              <li><a href="scanQr.php">Scan QR Code</a></li>
      ...
      <div class="position-relative">
        ...
        <div class="dropdown2">
          ...
          <div class="dropdown2-content">
            <p style="color: #fff;"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;&nbsp;<?php echo $user; ?></p>
            <a href="settings.php"><i class="fa fa-cog" aria-hidden="true"></i>&nbsp;&nbsp;Settings</a>
            <a href="" id="logout" style="color: red; font-weight: 700;"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp;&nbsp;Log Out</a> 
          </div>        
        </div>
           
        <i style="margin-left: 5px;" class="fa fa-bars mobile-nav-toggle"  id="navbtn" aria-hidden="true" style="color: #fff; font-size: 28px; padding-left: 10px;"></i>
      </div>
    </div>  
  </header>
