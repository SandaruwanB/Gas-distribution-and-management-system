<?php
    ...
    $limit = 12;
    $page = isset($_GET['did']) ? $_GET['did'] : 1 ;
    $start = ($page - 1) * $limit;
    $query2 = mysqli_query($con, "SELECT * FROM user_details,roles,dealer_gas_details WHERE dealer_gas_details.dealerNic = user_details.nic AND roles.id = user_details.roleId AND roles.name = 'dealer'");
...
<body>
   ...
   <main id="main" class="main all-data">
        <div class="pagetitle">
            <h1>Seller Accounts Control</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                    <li class="breadcrumb-item active">Seller Accounts Control</li>
                </ol>
            </nav>
        </div>
        ...
        <table class="table table-hover mt-5">
            ...
            <tbody>
                <?php
                    ...
                    $query = mysqli_query($con, "SELECT * FROM user_details,roles,dealer_gas_details WHERE dealer_gas_details.dealerNic = user_details.nic AND roles.id = user_details.roleId AND roles.name = 'dealer' LIMIT $start, $limit");
                        ...
                        while($row = mysqli_fetch_assoc($query)){
                            echo '
                                <tr>
                                    ...
                                    <td class="text-center"><button id="stoc-view" value='.$row['nic'].' class="btn btn-sm btn-primary">View Stock Details</button><button class="btn btn-danger btn-sm" style="margin-left: 10px;" value='.$row['nic'].' id="drmove-btn">Remove</button></td>
                                </tr>
                            ';
                            ++$loop;
                        }
    ...
    <main id="main" class="main stock-data d-none">
        <div class="pagetitle">
            <h1>Seller Stock Details</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="sellerAccounts.php">Seller Accounts Control</a></li>
                    <li class="breadcrumb-item active">Seller Stock Details</li>
                </ol>
            </nav>
        </div>
        <div class="cont">
